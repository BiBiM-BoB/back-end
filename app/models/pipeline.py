...
class Pipeline(db.Model):
    ...
    def __init__(self, pipeline_name, repo_url, jenkinsfile_path, owner_id):
...
class PipelineSchema(ma.Schema):
    class Meta:
        fields = ('id', 'pipeline_name', 'repo_url', 'jenkinsfile_path', 'owner_id', 'createAt', 'updateAt', 'deleteAt')
