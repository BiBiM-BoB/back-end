...
class SecurityResult(db.Model):
    ...
    def __init__(self, pipeline_id, user_id, resultfile_path, high, middle, low):
...
class SecurityResultSchema(ma.Schema):
    class Meta:
        fields = ('id', 'pipeline_id', 'user_id', 'resultfile_path', 'high', 'middle', 'low', 'createAt', 'updateAt', 'deleteAt')
